...
Sonuç: `dist\sap-radar-docker-1.7.0.zip` (~55 MB) — gönderilecek tek dosya.
...
```bash
unzip sap-radar-docker-1.7.0.zip -d sap-radar
...
> **Bedeli:** imajı alan herkes `docker run --rm sap-proje-radari:1.7.0 cat /app/.env` ile
