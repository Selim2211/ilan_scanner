...
Sonuç: `dist\sap-radar-docker-1.9.1.zip` (~55 MB) — gönderilecek tek dosya.
...
```bash
unzip sap-radar-docker-1.9.1.zip -d sap-radar
...
> **Bedeli:** imajı alan herkes `docker run --rm sap-proje-radari:1.9.1 cat /app/.env` ile
